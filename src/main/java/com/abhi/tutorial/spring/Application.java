...
//		A spring application needs the following three to run
//		It will need a bean objects managed by the spring 
//		What are the dependencies for the bean
//		where to find the beans // No need as default is package and subpackge of the spring boot class
